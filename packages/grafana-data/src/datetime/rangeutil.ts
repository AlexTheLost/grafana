...
const rangeOptions: TimeOption[] = [
  ...
  { from: 'now-1w/w', to: 'now-1w/w', display: 'Передыдущая неделя' },
  { from: 'now-1M/M', to: 'now-1M/M', display: 'Передыдущий месяц' },
  { from: 'now-1Q/fQ', to: 'now-1Q/fQ', display: 'Previous fiscal quarter' },
  { from: 'now-1y/y', to: 'now-1y/y', display: 'Передыдущий год' },
  ...
  { from: 'now-1y', to: 'now', display: 'Последние 1 год' },
